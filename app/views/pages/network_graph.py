...
def graph_layout():
    ...
    return html.Div([
        ...
        dbc.Container([
            html.P("The System Graph in CyberGator provides a visual representation of the System Under Evaluation (SUE), mapping out its components "
            "and connections to analyze network security, dependencies, and risk factors.", className="mb-3"),
            html.P("CyberGator uses Neo4j, a graph database, to enhance the efficiency and accuracy of system analysis by identifying critical nodes, "
            "attack paths, and structural vulnerabilities.", className="mb-3"),

            html.H5("How the System Graph Works", className="mt-4"),
            html.Ul([
                html.Li("Nodes Represent System Components – Each node corresponds to a server, workstation, firewall, router, or database, with "
                "attributes such as function, vulnerabilities (CVE data), and risk levels."),
                html.Li("Edges Define Relationships – Edges represent connections and dependencies between components, helping visualize how an attack could spread."),
            ...
            html.Ul([
                ...
                html.Li("Test System Changes – Modify system configurations in Simulation Mode to see how updates impact resilience before applying them permanently."),
            ], className="mb-3"),
