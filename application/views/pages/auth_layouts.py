        ...
        dbc.Card([
            dbc.CardBody([
                dbc.Form([
                    ...
                    dbc.Button("Login", id="login-btn", n_clicks=0, color="primary", className="w-100 mb-3"),
                    dbc.Button("Register", id="signup-btn", n_clicks=0, color="success", className="w-100 mb-3"),
